...
Assignments live in `assignments//`, and the website reads `config.json` to display them. Follow these steps to create both.
...
1. Create `assignments//README.md` following the [assignment template](../../../templates/assignment-template.md)
...
**Register the assignment:**
    ...
    node .github/skills/new-assignment/scripts/update-config.js  "" ""

**Register each file as an attachment** (starter code, data files, etc.):

    node .github/skills/new-assignment/scripts/add-attachment.js  ""  
